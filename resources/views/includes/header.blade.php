    ...
    <div id="nav">
        ...
        <div id="nav-top">
            <div class="container">
                ...
                <!-- logo -->
                <div class="nav-logo">
                    <a href="index.html" class="logo"><img src="{{url('frontend/img/logo.png')}}" alt=""></a>
                </div>
                <!-- /logo -->
                                        ...
                                        <div id="tab1" class="tab-pane fade in active">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img
                                                                src="{{url('frontend/img/post-10.jpg')}}" alt=""></a>
                                                        <div class="post-body">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img
                                                                src="{{url('frontend/img/post-13.jpg')}}" alt=""></a>
                                                        <div class="post-body">
                                                            <div class="post-category">
                                                                <a href="category.html">Travel</a>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img
                                                                src="{{url('frontend/img/post-12.jpg')}}" alt=""></a>
                                                        <div class="post-body">
                                                            <div class="post-category">
                                                                <a href="category.html">Lifestyle</a>
                                                            </div>
                                        ...
                                        <div id="tab2" class="tab-pane fade in">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img
                                                                src="{{url('frontend/img/post-5.jpg')}}" alt=""></a>
                                                        <div class="post-body">
                                                            <div class="post-category">
                                                                <a href="category.html">Lifestyle</a>
                                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img
                                                                src="{{url('frontend/img/post-8.jpg')}}" alt=""></a>
                                                        <div class="post-body">
                                                            <div class="post-category">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img
                                                                src="{{url('frontend/img/post-9.jpg')}}" alt=""></a>
                                                        <div class="post-body">
                                                            <div class="post-category">
                                                                <a href="category.html">Lifestyle</a>
                                                            </div>
