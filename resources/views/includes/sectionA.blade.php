        ...
        <div id="hot-post" class="row hot-post">
            <div class="col-md-8 hot-post-left">
                ...
                <div class="post post-thumb">
                    <a class="post-img" href="blog-post.html"><img src="{{url('frontend/img/hot-post-1.jpg')}}"
                            alt=""></a>
                    <div class="post-body">
            ...
            <div class="col-md-4 hot-post-right">
                <!-- post -->
                <div class="post post-thumb">
                    <a class="post-img" href="blog-post.html"><img src="{{url('frontend/img/hot-post-2.jpg')}}"
                            alt=""></a>
                    <div class="post-body">
                        <div class="post-category">
                            <a href="category.html">Lifestyle</a>
                ...
                <!-- post -->
                <div class="post post-thumb">
                    <a class="post-img" href="blog-post.html"><img src="{{url('frontend/img/hot-post-3.jpg')}}"
                            alt=""></a>
                    <div class="post-body">
                        <div class="post-category">
